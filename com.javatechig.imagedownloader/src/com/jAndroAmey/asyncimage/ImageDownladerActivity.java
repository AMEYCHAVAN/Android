package com.jAndroAmey.asyncimage;
...
public class ImageDownladerActivity extends Activity {
	...
	private class ImageDownloader extends AsyncTask<String, Void, Bitmap> {
		...
		protected Bitmap doInBackground(String... param) {
			// TODO Auto-generated method stub
			Log.i("Async-Example", "doInBackground Called"+param[0]);
			return downloadBitmap(param[0]);
		}

		@Override
		protected void onPreExecute() {
			Log.i("Async-Example", "onPreExecute Called -processbar started");
		...
		private Bitmap downloadBitmap(String url) {
			Log.i("Async-Example", "downloadBitmap Called");
